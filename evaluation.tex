...
\begin{table*}
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{lrrrrrlrrrr} \toprule
		\multicolumn{5}{c}{methods2test} & & \multicolumn{5}{c}{Ghafari's algorithm} \\
		...
		goja-0.1.14/goja-core  & 11.52 & 27  & 80 &  34\%  &  &  commons-email-1.3.3 & 8.78 & 90  & 130 &  69\%       \\
		mock-socket-0.9.0    & 1.09  & 4  & 34 &  12\%    &  &  PureMVC-1.0.8 & 19.46 & 34  & 43 &  79\%         \\
		project-sunbird-4.3.0/sunbird-lms-service   & 45.36 & 310  & 984 &  31\%   &  &  XStream-1.4.4 & 54.93 & 513  & 968 &  53\%      \\
		optiq-0.8/core    & 93.94  & 26  & 1346 &  2\%    &  &  JGAP-3.4.4  & 73.96 & 1015  & 1390 &  73\%       \\
		\bottomrule
		Geometric Mean &   &  &  &  12\% &   &  &  &  &  &  68\% 
	\end{tabular}}
