...
\begin{table*}[b]
	...
	\begin{tabular}{lrrrr}
		\toprule
		Benchmark & Total LOC & Test Suite LOC & Soot's Runtime (s)  & \thead{Doop's Runtime \\ on mock analysis \\ NO\_INTERPROC (s)} \\
		\midrule
		bootique-2.0.B1-bootique           		&  15530   & 8595   &  59   & 86    \\
		commons-collections4-4.4           		&  65273   & 36318  &  88   & 53        \\
		flink-core-1.13.0-rc1           		&  117310  & 49730  &  282  & 194        \\
		jsonschema2pojo-core-1.1.1         		&  8233    & 2885   &  187  & 180       \\
		maven-core-3.8.1   		           		&  38866   & 11104  &  169  & 126        \\
		micro-benchmark         		  		&  559     & 491	&  50   & 24        \\
		mybatis-3.5.6         		  			&  68268   & 46334  &  391  & 344        \\
		quartz-core-2.3.1        	  			&  35355   & 8423   &  210  & 40      \\
		vraptor-core-3.5.5         	  			&  34244   & 20133  &  177  & 251      \\
		\bottomrule
		Total         	  						&  383638  & 184013 &  1613  & 1298      \\
	\end{tabular}
	%	\end{adjustbox}
	\label{tab:runtimes}
\end{table*}
...
We have evaluated \textsc{MockDetector} on 8 open-source benchmarks, along with a micro-benchmark that we developed to test our tool. Table~\ref{tab:runtimes} presents the LOC and runtime information for each benchmark. The 9 benchmarks include over 383 kLOC, with 184 kLOC in the test suites measured by SLOCCount. Our Doop analysis's runtime on intra-procedural mock analysis is obtained by taking the difference of two Doop runs on the same benchmark, where one run is associated with extra logic analyzing intra-procedural mocks, which would correctly reflect the run-time spent on analyzing intra-procedural mock invocations.   %Add reference for SLOCCount.
