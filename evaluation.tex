...
We will now quantitatively characterize the performance of our mock analysis implementations on a suite of popular open-source applications. We also provide evidence about the importance of mock invocations to test suites, and discuss applications of our analysis to focal method detection.
...
\paragraph{Application: Mocks are important} You need our analysis (or a dynamic version thereof) to know!

\paragraph{Application: Focal methods} Hmm we don't actually have anything here yet?
