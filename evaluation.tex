...
\begin{table*}
	\centering
	\caption{Comparison of Code Coverages and Branch Coverages with all test cases, and with test cases excluding intraproc mock objects.}
	\vspace*{.5em}
	\begin{tabular}{lrrrrr} \toprule
			& \multicolumn{2}{c}{Code Coverage} & & \multicolumn{2}{c}{Branch Coverage} \\
...
\begin{table*}
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{lrrrrlrrr} \toprule
		\multicolumn{4}{c}{methods2test} & & \multicolumn{4}{c}{Ghafari's algorithm} \\
		\cmidrule{1-4} \cmidrule{6-9}
		\thead{Benchmark} & \thead{Reported \\ Focal Methods} & \thead{Test Cases} & \thead{\% of test cases \\ with focal \\ methods detected} &  & \thead{Benchmark} & \thead{Reported \\ Focal Methods} & \thead{Test Cases} & \thead{\% of test cases \\ with focal \\ methods detected} \\ 
		\midrule 
		
		bootique-2.0.B1-bootique    & 129  & 228 &  57\%    &  &  commons-email-1.3.3  & 90  & 130 &  69\%       \\
		jsonschema2pojo-core-1.1.1  & 120  & 382 &  31\%    &  &  JGAP-3.4.4  & 1015  & 1390 &  73\%       \\
		maven-core-3.8.1   		    & 150  & 332 &  45\%    &  &  PureMVC-1.0.8  & 34  & 43 &  79\%         \\
		vraptor-core-3.5.5         	& 690  & 1139 &  61\%   &  &  XStream-1.4.4  & 513  & 968 &  53\%      \\
		\bottomrule
		Geometric Mean &   &    &  47\% &   &  &  &  &  68\% 
	\end{tabular}}
