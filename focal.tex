...
Meanwhile, since the heuristic of Ghafari's algorithm requires the unit test case to have at least one assertion statement, the algorithm will presumably have undefined behaviour analyzing unit test cases without assertions.
