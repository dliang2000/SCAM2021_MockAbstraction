...
obvious.\todo{example?} The code snippet below illustrates a self-made \texttt{BarcodeMock} object from project barbecue~\footnote{http://barbecue.sourceforge.net/}, which does not use any known mocking libraries.
